...
public class PathMatchingResourceLoaderTest {
  ...
  public void testGetMigrations() throws Exception {
    PathMatchingResourceLoader loader = createMigrationsLoader();
  ...
  protected PathMatchingResourceLoader createMigrationsLoader() {
    Properties properties = new Properties();
    properties.setProperty("changelog", "CHANGELOG");
    PathMatchingResourceLoader loader = new PathMatchingResourceLoader("net/harawata/scripts", "utf-8", properties);
    return loader;
  }
}
